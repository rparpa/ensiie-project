...
INSERT INTO Annonce (id_user, id_etat, titre, description, prix, nb_signal, date_publication) VALUES ('5', '4', 'Ordinateur Acer Aspire reconditionné', 'Vente ordinateur reconditionné en parfait état de marche. PC n°23 : Acer Aspire, Processeur: AMD Athlon X2 64, Carte intégrée, Mémoire RAM:, 3 Go DDR3, Stockage:, 500 Go HDD, Système d’exploitation: Emmabuntüs, Prix: 110€, Livraison possible en main propre, État : Reconditionné par le vendeur.', '240', 0, '2015-06-25 23:38:26');
INSERT INTO Annonce (id_user, id_etat, titre, description, prix, nb_signal, date_publication) VALUES ('6', '3', 'Imprimante HP ENVY Photo 6232 Neuve', 'Je vends une imprimante HP ENVY Photo 6232 Neuve (carton non ouvert - Seul le code barre a été découpé). * Imprime, scanne, copie. * Imp. rapide (Noir, 13ppm). * Idéal document : 2 cartouches - Wi-Fi airPrint, Wi-Fi ePrint. * Haute qualité (4800x1200ppp) - A4. * Impression gratuite possible jusqu''à 15 pages/mois (instant ink). Facture - Garantie', '120', 0, '2012-05-12 05:01:02');
INSERT INTO Annonce (id_user, id_etat, titre, description, prix, nb_signal, date_publication) VALUES ('7', '4', 'Iphone SE 64 GO débloqué', 'iphone SE TBE 64 GO LIBRES TTS OERATEURS - entierement fonctionnel , y compris l''identification digitale ( ID ), MAJ IOS 13.3.1 installée , réenitialisé et remis a zero pour un nouvel utilisateur, des mini chocs d''usage sur les cotes , ecran d''origine et tres propre, capacité batterie 90 %', '253', 0, '2017-09-28 01:23:55');
INSERT INTO Annonce (id_user, id_etat, titre, description, prix, nb_signal, date_publication) VALUES ('7', '2', 'Samsung GT-C3590', 'Téléphone Samsung GT-C3590 avec tout son équipement, Peu utilisé, Livraison à négocier Blois et alentours', '150', 0, '2000-11-08 15:51:00');
