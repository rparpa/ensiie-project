...
CREATE TABLE Categorie_annonce (
    ...
    CONSTRAINT fk2_categorie_annonce FOREIGN KEY(id_categorie) REFERENCES Categorie(id_categorie) ON DELETE CASCADE
);
...
INSERT INTO Utilisateur (nom, prenom, pseudo, password, email, telephone, promo, droit_publication, nb_signal_user, admin) VALUES ('Admin', 'Paul', 'Admin_paul', 'root', 'admin@test.fr', '0625647421', '2A', 'true', 0, 'true');
INSERT INTO Utilisateur (nom, prenom, pseudo, password, email, telephone, promo, droit_publication, nb_signal_user, admin) VALUES ('Abdallaoui', 'Mehdi', 'DrMehdi', 'root', 'mehdi.abdallaoui@ensiie.fr', '0662549127', '2A', 'true', 0, 'false');
INSERT INTO Utilisateur (nom, prenom, pseudo, password, email, telephone, promo, droit_publication, nb_signal_user, admin) VALUES ('Bart', 'Frescinel', 'fbart', 'root', 'frescinel.bart@ensiie.fr', '0664532718', '2A', 'true', 0, 'false');
INSERT INTO Utilisateur (nom, prenom, pseudo, password, email, telephone, promo, droit_publication, nb_signal_user, admin) VALUES ('Elbissis', 'Redwan', 'redwan', 'root', 'redwan.elbissis@ensiie.fr', '0648152726', '2A', 'true', 0, 'false');
