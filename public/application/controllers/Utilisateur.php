...
class Utilisateur extends CI_Controller
{
    ...
    public function profil()
    {
        if(isset($this->session->userdata['logged_in'])){
			...
			$admin=$infos[0]['admin'];
			$data = ["nom"=>$infos[0]['nom'],"prenom"=>$infos[0]['prenom'],"nbAnnonces" => $this->annonce->totalAnnonces(),"promo"=>$promo,"pseudo"=>$pseudo,"telephone"=>$telephone,"annonces"=>$annonce, "admin"=>$admin];
            $this->load->view('elements/header',$this->data);
