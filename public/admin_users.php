...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['user_id']) && isset($_POST['type']) && $_POST['type'] == 'del') {
        $userService->deleteUser($userService->getUserById($_POST['user_id']));
    }
}
                        ...
                        <?
                            ...
                            foreach ($users as $user) {
                                ...
                                echo "<tr>
                                    ...
                                    <td>" . $user->getAge() . "</td>
                                    <td>" . $user->getMail() . "</td>
                                    <td>" . $user->isValidator() . "</td>
                                    <td>
                                    <a class=\"badge badge-danger delusers\" id=\"" . $user->getId() . "\">
